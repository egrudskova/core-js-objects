...
function mergeObjects(objects) {
  return objects.reduce((mergedObj, currObj) => {
    const resObj = { ...mergedObj };
    Object.entries(currObj).forEach(([key]) => {
      resObj[key] = resObj[key] ? resObj[key] + currObj[key] : currObj[key];
    });
    return resObj;
  }, {});
}
